...
import deakin.sit.improvedpersonalizedlearningexperiencesapp.account.viewmodel.CheckoutViewModel;
...
import deakin.sit.improvedpersonalizedlearningexperiencesapp.databinding.ActivityCheckoutBinding;

/**
 * Checkout implementation for the app
 */
public class CheckoutActivity extends AppCompatActivity {
    Button backButton, purchaseStartButton, purchaseIntermediateButton, purchaseAdvancedButton;
    ...
    private void initializeUi() {
        ...
        purchaseStartButton = findViewById(R.id.purchaseStartButton);
        purchaseIntermediateButton = findViewById(R.id.purchaseIntermediateButton);
        purchaseAdvancedButton = findViewById(R.id.purchaseAdvancedButton);

        purchaseStartButton.setOnClickListener(this::requestPayment);
        purchaseIntermediateButton.setOnClickListener(this::requestPayment);
        purchaseAdvancedButton.setOnClickListener(this::requestPayment);
    ...
    private void setGooglePayAvailable(boolean available) {
        if (available) {
            purchaseStartButton.setVisibility(View.VISIBLE);
            purchaseIntermediateButton.setVisibility(View.VISIBLE);
            purchaseAdvancedButton.setVisibility(View.VISIBLE);
        } else {
    ...
    public void requestPayment(View view) {
        ...
        purchaseStartButton.setClickable(false);
        purchaseIntermediateButton.setClickable(false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case LOAD_PAYMENT_DATA_REQUEST_CODE:
                ...
                purchaseStartButton.setClickable(true);
                purchaseIntermediateButton.setClickable(true);
